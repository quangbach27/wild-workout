...
import (
	...
	"github.com/quangbach27/wild-workout-project/internal/common/errors"
...
func Unauthorised(slug string, err error, w http.ResponseWriter, r *http.Request) {
	httpResponseWithError(err, slug, w, r, "Unauthorised", http.StatusUnauthorized)
}
...
func ResponseWithSlugError(err error, w http.ResponseWriter, r *http.Request) {
...
func (errorResp ErrorResponse) Render(w http.ResponseWriter, r *http.Request) error {
	w.WriteHeader(errorResp.httpStatus)
	return nil
}
