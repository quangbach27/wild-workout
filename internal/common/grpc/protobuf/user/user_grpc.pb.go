...
const (
	UsersService_GetTrainingBalance_FullMethodName    = "/user.UsersService/GetTrainingBalance"
	UsersService_UpdateTrainingBalance_FullMethodName = "/user.UsersService/UpdateTrainingBalance"
)
...
func (UnimplementedUsersServiceServer) GetTrainingBalance(context.Context, *GetTrainingBalanceRequest) (*GetTrainingBalanceResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetTrainingBalance not implemented")
}
func (UnimplementedUsersServiceServer) UpdateTrainingBalance(context.Context, *UpdateTrainingBalanceRequest) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateTrainingBalance not implemented")
}
