...
const file_users_proto_rawDesc = "" +
	...
	"\ramount_change\x18\x02 \x01(\x03R\famountChange\"\x0f\n" +
	"\rEmptyResponse2\xc1\x01\n" +
	"\fUsersService\x12[\n" +
	"\x12GetTrainingBalance\x12 .users.GetTrainingBalanceRequest\x1a!.users.GetTrainingBalanceResponse\"\x00\x12T\n" +
	"\x15UpdateTrainingBalance\x12#.users.UpdateTrainingBalanceRequest\x1a\x14.users.EmptyResponse\"\x00BJZHgithub.com/quangbach27/wild-workout/internal/common/genproto/users;usersb\x06proto3"
